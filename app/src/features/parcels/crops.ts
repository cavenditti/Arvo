...
/** Default season for a new field — the current calendar year. */
export function currentSeasonYear(): number {
  return new Date().getFullYear();
}

// Simple client-side YYYY-MM-DD validation. The form now uses DateField (always emits valid
// ISO), but imported GeoJSON properties and defensive submit checks still go through this.
